...
- ⚠️ ممنوع منعا باتا استخدام اي رموز برمجية او صيغ LaTeX في المعادلات! اكتب جميع المعادلات الرياضية بلغة عربية واضحة ورموز بسيطة مفهومة للطلاب:
  * استخدم علامة × للضرب، و÷ للقسمة، بدلا من النقطة او /
  * اكتب "تربيع" او "مرفوع للاس 2" بدلا من ^2
  * اكتب الكسور مثل "مقسوما على" او "بسط / مقام" بشكل واضح
  * لا تستخدم علامات $ أو \\ أو اي رموز برمجية اطلاقا، اكتب كل شيء بكلمات عربية مفهومة.
- داخل خلايا الجداول، لا تستخدم وسم <br> للفصل بين النقاط؛ استخدم فاصلة (،) أو فاصلة منقوطة (؛) بدلاً من ذلك.`;
}
